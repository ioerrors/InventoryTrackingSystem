...
public:
    ...
    bool operator>(const Movie& otherMovie);  // check if this movie is greater than other movie
    bool operator<(const Movie& otherMovie);  // check if this movie is less than other movie
};
